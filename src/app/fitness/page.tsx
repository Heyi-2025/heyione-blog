  ...
  return (
    <div className="min-h-screen bg-[#060608] text-white overflow-hidden">
      <div className="fixed inset-0 pointer-events-none">
        ...
        />
        <div className="absolute top-0 left-1/4 w-64 h-64 bg-violet-400/15 blur-[80px]" />
      </div>

      <main className="relative max-w-3xl mx-auto px-6 py-16">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-[13px] text-violet-400 hover:text-violet-300 transition-colors mb-16"
        >
          ← 返回首页
        </Link>

        <h1 className="text-2xl font-light text-white mb-2">健身计划</h1>
